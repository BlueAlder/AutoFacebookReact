...
const whitelisted_photo_senders = [Constants.senderID["erol"], Constants.senderID["grace"], Constants.senderID["sam"]];
const whitelisted_photo_threads = [Constants.threadID["bangme"], Constants.threadID["gfBang"]];
